...
title: "Week 5: Fitting Experimental Data to Models II"
---

![Two-panel plot of a deuterium exchange reaction: the lower panel shows ion counts on a log scale vs. time for H3+, H2D+, D2H+, and D3+ with experimental data points and kinetic model fits; the upper panel shows the fit residuals.]({{site.baseurl}}/assets/images/week05/deuteration_results.png)
...
- [Rate Derivation]({{ "/rate-derivation/" | relative_url }})


## Notebooks

- [deuteration.ipynb](https://github.com/{{ site.github_username }}/che155/blob/master/_notebooks/week05/deuteration.ipynb) - [Open in Google Colab](https://colab.research.google.com/github/{{ site.github_username }}/che155/blob/master/_notebooks/week05/deuteration.ipynb) - [Download](https://raw.githubusercontent.com/{{ site.github_username }}/che155/master/_notebooks/week05/deuteration.ipynb)
