...
title: "Week 4: Fitting Experimental Data to Models I"
---
...
- [`scipy.integrate`](https://docs.scipy.org/doc/scipy/reference/integrate.html) contains a number of functions that can perform numerical integration. We will use `trapezoid` and `simpson`.
...
- [nmr-analysis.ipynb](https://github.com/{{ site.github_username }}/che155/blob/master/_notebooks/week04/nmr-analysis.ipynb) - [Open in Google Colab](https://colab.research.google.com/github/{{ site.github_username }}/che155/blob/master/_notebooks/week04/nmr-analysis.ipynb) - [Download](https://raw.githubusercontent.com/{{ site.github_username }}/che155/master/_notebooks/week04/nmr-analysis.ipynb)
